 ...
 */
case class SocialUser(id: UserId, firstName: String, lastName: String, fullName: String, state: String, email: Option[String],
...
object SocialUser {
  def apply(i: Identity): SocialUser = {
    SocialUser(
      i.id, i.firstName, i.lastName, i.fullName, i.state,
